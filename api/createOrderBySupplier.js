...
module.exports = {
    createOrderBySupplier :  async (req, res) =>{
            args = {"po":req.body.po,"cid":req.body.cid,"shid":req.body.shid,"trno":req.body.trno,"regid":req.body.regid,"dosts":req.body.dosts,"gtin":req.body.gtin,"uts":req.body.uts}
            obj = {
                chainId : "mychannel",
                chaincodeId : "track",
